...
import 'package:laborlink/widgets/custom_pin_code_text_field.dart';
...
class _EnterOtpScreenState extends State<EnterOtpScreen> {
  ...
  Future<String?> getData() async {
    return await PreferenceManager.getEmail();
  }
  ...
  onTapContinue(BuildContext context) async {
    ...
    if (data == "worker") {
      Get.offAndToNamed(AppRoutes.facialVerification);
    } else {
